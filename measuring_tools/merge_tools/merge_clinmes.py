    ...
    for i, _file in enumerate(os.listdir(path_clinmes_one)):
        ...
        for _file_seda in os.listdir(path_clinmes_two):
            ...
            if test_check in _file:
                ...
                df_seda = pd.read_csv(filename_seda, sep=';', names=cols.CLINME_COLS, dtype={'distribuidora': 'str', 'comercialitzadora': 'str', 'agree_tipo': 'str'})
                df_erp = pd.read_csv(filename_erp, sep=';', names=cols.CLINME_COLS, dtype={'distribuidora': 'str', 'comercialitzadora': 'str', 'agree_tipo': 'str'})
                ...
                df_clinme.to_csv(
                    filename_dest, sep=';', header=False, columns=cols.CLINME_COLS, index=False,
                    line_terminator='\n'
                )
